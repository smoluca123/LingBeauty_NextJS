      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12 grid grid-cols-1 gap-6 md:mb-16 md:grid-cols-2 md:gap-8 lg:grid-cols-3">
          {filteredArticles.map((article) => (
            <article
              key={article.id}
              className="group cursor-pointer overflow-hidden rounded-2xl bg-white shadow-md transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl"
            >
              {/* Image */}
        ...
        <div className="flex justify-center">
          <button className="rounded-full border-2 border-foreground bg-white px-12 py-4 text-base font-semibold text-foreground shadow-md transition-all duration-300 hover:-translate-y-1 hover:bg-foreground hover:text-white hover:shadow-xl active:translate-y-0">
            Tất cả bài viết
          </button>
        </div>
      </div>
