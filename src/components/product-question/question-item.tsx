...
import { CheckCircle2, Clock, MoreVertical, Pencil, Trash2, User } from 'lucide-react';
import { IProductQuestion, ProductQuestionStatus } from '@/lib/types/interfaces/apis/product-question.interfaces';
      ...
      <div className="rounded-lg border bg-card p-4 space-y-3">
        ...
        {isAnswered && question.answer ? (
          <div className="space-y-1 rounded-lg bg-muted/50 p-3">
            <div className="flex items-center gap-2">
              <div className="flex h-6 w-6 items-center justify-center rounded-full bg-primary-pink">
