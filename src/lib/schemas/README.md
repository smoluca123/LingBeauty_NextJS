...
├── banner.schema.ts          # Banner forms (create & edit)
├── banner-group.schema.ts    # Banner group forms
├── coupon.schema.ts          # Coupon forms
├── flash-sale.schema.ts      # Flash sale forms (create & edit)
├── search.schema.ts          # Search forms
