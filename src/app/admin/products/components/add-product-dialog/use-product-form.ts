...
import type { IProductFormData, ICreateProductPayload, ICreateProductVariantPayload } from '@/lib/types/interfaces/apis/admin-product.interfaces';
import { generateSlug, generateSku } from '../product-form/product-form-helpers';

// Re-export để backward compatibility
export { generateSlug, generateSku };
